window.addEventListener("load",()=>{
  ...
  /*ADDED*/
  const drumArray = [
    "js/audio/drum_track_1.wav", 
    "js/audio/drum_track_2.wav", 
    "js/audio/drum_track_3.wav", 
    "js/audio/drum_track_4.wav", 
    "js/audio/drum_track_5.wav", 
    "js/audio/drum_track_6.wav", 
    "js/audio/drum_track_7.wav", 
    "js/audio/drum_track_8.wav", 
    "js/audio/drum_track_9.wav", 
    "js/audio/drum_track_10.wav"
  ];
  ...
  const melodyArray = [
    "js/audio/melody_track_1.wav", 
    "js/audio/melody_track_2.wav", 
    "js/audio/melody_track_3.wav"
  ];
  ...
  function playMelody(value){
    pauseMel();
    audioM = new Audio();
    audioM.src = melodyArray[value];
    audioM.loop = true;
    var buffer = 2
    if(audioM.currentTime > audioM.duration - buffer){
        audioM.currentTime = 0
        audioM.play()
    }
    else{
